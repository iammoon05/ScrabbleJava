...
static class ScrabbleTestSuite {
    ...
    Map<Character, Integer> scoreMap = ScrabbleTest.getScoreMap();
    ...
    void TestCalculateScore() {
        ...
        // expectedResults is an ordered list of booleans
        ...
        for (Map.Entry<String, Integer> entry:  Word_Scores.entrySet()) {
            Integer score = Scrabble.calculateScore(entry.getKey(), scoreMap);
